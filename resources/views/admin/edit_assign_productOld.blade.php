    ...
    <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class=" container-fluid ">
                ...
                <form action="{{ route('update.customer.product',$customer->id) }}" method="POST"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                    ...
                                    <select name="customer_id" data-placeholder="Select a Customer..."
                                        ...
                                        @if ($customers)
                                            ...
                                            @foreach ($customers as $user)
                                                <option value="{{ $user->id }}" @if ($customer->id == $user->id)
                                                        selected
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <select name="product_id[]" data-placeholder="Select a Product..."
                                        ...
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}" data-name="{{ $product->name }}" @if (in_array($product->id, $selectedProductIds)) selected @endif>
                                                {{ $product->name }} -
                                ...
                                <div id="priceInputs">
                                    ...
                                    <div class="card-body pt-0">
                                        <label class="required form-label">Assign Cost for {{ $products->find($productId)->name }}</label>
                                        <input type="text" name="product_prices[{{ $productId }}]" class="form-control mb-2"
                                            placeholder="Assign Price" value="{{ $productPrices[$productId] ?? '' }}">
                                    </div>
                                @endforeach
                                </div>
