                                    ...
                                    @if ($payments)
                                        ...
                                        @foreach ($payments as $payment)
                                            <option value="{{ $payment->Id }}"
                                                {{ (old('payment_method_id') == $payment->Id || (isset($user) && $user->PaymentMethodRef == $payment->Id)) ? 'selected' : '' }}>
                                                {{ $payment->Name }}
                                            </option>
                                        @endforeach
                                    @else
                                ...
                                <select name="term_id" data-placeholder="Select a Terms..."
                                    ...
                                    @if ($terms)
                                        ...
                                        <option value="{{ $term->Id }}"
                                            {{ (old('term_id') == $term->Id || (isset($user) && $user->SalesTermRef == $term->Id)) ? 'selected' : '' }}>
                                            {{ $term->Name }}
                                        </option>
                                    @endforeach
                                    
                                    @else
                                        <option disabled>Terms Not available...
                                        </option>
                                    @endif
                                </select>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="business_number" class="form-control mb-2"
                                        placeholder="Business Number..."   value="{{ old('business_number', $user->BusinessNumber ) }}">
                                    <!--end::Input-->
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--begin::Input-->
                                    <textarea name="notes" class="form-control mb-2" placeholder="Notes..." value="{{$user->Notes }}"></textarea>
                                    <!--end::Input-->
                                    @error('notes')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="title" class="form-control mb-2"
                                                    placeholder="Enter title..." value="{{ old('title', $user->Title ?? "") }}">
                                                <!--end::Input-->
                                                @error('title')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="company_name"
                                                            ...
                                                            value="{{ old('company_name' , $user->CompanyName ?? "") }}">
                                                        <!--end::Input-->
                                                        @error('company_name')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="first_name" class="form-control mb-2"
                                                            placeholder="First Name..." value="{{ old('first_name' , $user->GivenName ?? "") }}">
                                                        <!--end::Input-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="last_name" class="form-control mb-2"
                                                            placeholder="Middle Name..." value="{{ old('last_name' , $user->FamilyName ?? "") }}">
                                                        <!--end::Input-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="email" name="email" class="form-control mb-2"
                                                            placeholder="Email..." value="{{ old('email', $user->PrimaryEmailAddr->Address ?? "") }}">
                                                        <!--end::Input-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="tel" name="phone_number"
                                                            ...
                                                            value="{{ old('phone_number', $user->PrimaryPhone->FreeFormNumber ?? "") }}">
                                                        <!--end::Input-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="tel" name="mobile_number"
                                                            class="form-control mb-2" placeholder="Mobile Number..."
                                                            value="{{ old('mobile_number', $user->Mobile->FreeFormNumber ?? "") }}">
                                                        <!--end::Input-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="suffix" class="form-control mb-2"
                                                            placeholder="Suffix " value="{{ old('suffix', $user->Suffix ?? "") }}">
                                                        <!--end::Input-->
                                                        @error('suffix')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="fax" class="form-control mb-2"
                                                            placeholder="Fax..." value="{{ old('fax', $user->Fax->FreeFormNumber ?? "") }}">
                                                        <!--end::Input-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="other" class="form-control mb-2"
                                                            placeholder="Other... " value="{{ old('other', $user->AlternatePhone->FreeFormNumber ?? "") }}">
                                                        <!--end::Input-->
                                                        @error('other')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="website" class="form-control mb-2"
                                                            placeholder="Website..." value="{{ old('website', $user->WebAddr->URI ?? "") }}">
                                                        <!--end::Input-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="address_1" class="form-control mb-2"
                                                    placeholder="Addres 1..." value="{{ old('address_1', $user->BillAddr->Line1 ?? "") }}">
                                                <!--end::Input-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="address_2" class="form-control mb-2"
                                                    placeholder="Street Address 2..." value="{{ old('address_2', $user->BillAddr->Line2 ?? "") }}">
                                                <!--end::Input-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="city" class="form-control mb-2"
                                                    placeholder="City ..." value="{{ old('city', $user->BillAddr->City ?? "") }}">
                                                <!--end::Input-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="country" class="form-control mb-2"
                                                    placeholder="Country..." value="{{ old('country', $user->BillAddr->Country ?? "") }}">
                                                <!--end::Input-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="shippingAddress_1" class="form-control mb-2"
                                                    placeholder="Addres 1..." value="{{ old('shippingAddress_1', $user->ShipAddr->Line1 ?? "") }}">
                                                <!--end::Input-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="shippingAddress_2" class="form-control mb-2"
                                                    ...
                                                    value="{{ old('shippingAddress_2', $user->ShipAddr->Line2 ?? "") }}">
                                                <!--end::Input-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="shippingCity" class="form-control mb-2"
                                                    placeholder="City ..." value="{{ old('shippingCity', $user->ShipAddr->City ?? "") }}">
                                                <!--end::Input-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="shippingCountry" class="form-control mb-2"
                                                    placeholder="Country..." value="{{ old('shippingCountry', $user->ShipAddr->Country ?? "") }}">
                                                <!--end::Input-->
