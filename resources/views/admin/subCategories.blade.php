...
@section('content')
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                <i class="ki-duotone ki-magnifier fs-3 position-absolute ms-4"><span
                                    ...
                                    id="search-subCategory" {{-- data-kt-ecommerce-category-filter="search" --}}
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <thead>
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            {{-- <th class="min-w-125px">SubCategory Description</th> --}}
                                            {{-- <th class="min-w-125px">Main Category</th> --}}
                                            <th class="text-end min-w-100px">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody class="fw-semibold text-gray-600" id="subCategory-table-body">
                                        @if ($categories)
                                                    ...
                                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                        <a href="{{ route('edit.subCategory', $category->id) }}">
                                                            <div class="symbol-label">
                                                                ...
                                                                <img src="{{asset('storage/subCategoryImages/'.$category->icon)}}"
    ...
    <script>
        $(document).ready(function() {
            $('#search-subCategory').on('keyup', function() {
                let searchValue = $(this).val().toLowerCase();

                $('#subCategory-table-body tr').each(function() {
                    let subCategoryName = $(this).find('td a').text().toLowerCase();
