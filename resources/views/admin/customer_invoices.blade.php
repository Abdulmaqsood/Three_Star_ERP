        ...
        <div class="toolbar" id="kt_toolbar">
            <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                    <!--begin::Title-->
                    <h1 class="text-dark fw-bold my-1 fs-2"> Invoices </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb fw-semibold fs-base my-1">
                        ...
                        <li class="breadcrumb-item text-muted"> <a href="{{ route('invoices') }}"
                                class="text-muted text-hover-primary"> Invoices </a> </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Info-->
                                                ...
                                                <tr class="even">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-5">
                                                                <!--begin::Title--> <a
                                                                    href="{{ route('show.invoice', $invoice->Id) }}"
                                                                    class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                                    data-kt-ecommerce-product-filter="product_name">#{{ $invoice->DocNumber }}</a>
                                                                <!--end::Title-->
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-end pe-0"> <span
                                                            class="fw-bold ms-3">{{ $invoice->TotalAmt }}$ </span> </td>
                                                    <td class="text-end pe-0">{{ $invoice->TotalAmt }}$</td>
                                                    {{-- <td class="text-end pe-0">{{ $invoice->description   ?? "null" }}</td> --}}
                                                    <td class="text-end pe-0">
                                                        <!--begin::Badges-->
                                                        <div class="badge badge-light-success">{{ $invoice->TotalAmt }} $</div>
                                                        <!--end::Badges-->
                                                    </td>
                                                    ...
                                                    <td class="text-end"> <a href="#"
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3"> <a
                                                                    href="{{ route('show.invoice', $invoice->Id) }}"
                                                                    class="menu-link px-3"> Details </a> </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3"> <a
                                                                    href="{{ route('edit.invoice', $invoice->Id) }}"
                                                            ...
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3"> <a
                                                                    href="{{ route('download.invoice', $invoice->Id) }}"
