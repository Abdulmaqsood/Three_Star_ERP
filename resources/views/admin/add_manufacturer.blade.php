            ...
            <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                    ...
                    <ul class="breadcrumb fw-semibold fs-base my-1">
                        ...
                        <li class="breadcrumb-item text-muted"> <a href="{{ route('add.manufacturer') }}"
                                class="text-muted text-hover-primary"> Store Management </a> </li>
                        <li class="breadcrumb-item text-muted"> <a href="{{ route('add.manufacturer') }}"
                                class="text-muted text-hover-primary"> Manufacturers </a> </li>
                        <li class="breadcrumb-item text-dark"> Add Manufacturer </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Info-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="email" name="email" class="form-control mb-2"
                                        placeholder="Manufacturer email" value="{{old('email')}}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="address" class="form-control mb-2"
                                        placeholder="Manufacturer address" value="{{old('address')}}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="city" class="form-control mb-2"
                                        placeholder="Manufacturer city" value="{{old('city')}}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="state" class="form-control mb-2"
                                        placeholder="Manufacturer state" value="{{old('state')}}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="country" class="form-control mb-2"
                                        placeholder="Manufacturer Country" value="{{old('country')}}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="postal_code" class="form-control mb-2"
                                        placeholder=" Manufacturer Postal Code" value="{{old('postal_code')}}">
                                    <!--end::Input-->
