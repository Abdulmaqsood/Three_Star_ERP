            ...
            <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                    ...
                    <ul class="breadcrumb fw-semibold fs-base my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('drafts') }}" class="text-muted text-hover-primary">
                                Drafts </a>
                        </li>
        ...
        <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class=" container-fluid ">
                <form action="{{ route('store.invoice') }}" method="POST"
                    ...
                    enctype="multipart/form-data" id="editDraftForm">
                    @csrf
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 w-lg-100 gap-lg-12">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="shipping_address" class="form-control mb-2"
                                        ...
                                        value="{{ old('shipping_address', $invoice->shipping_address ?? '') }}">
                                    <!--end::Input-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="shipping_city" class="form-control mb-2"
                                            ...
                                            value="{{ old('shipping_city', $invoice->shipping_city ?? '') }}">
                                        <!--end::Input-->
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="shipping_country" class="form-control mb-2"
                                            ...
                                            value="{{ old('shipping_country', $invoice->shipping_country ?? '') }}">
                                        <!--end::Input-->
                                                    ...
                                                    <select name="products[{{ $index }}][id]" id="product"
                                                        ...
                                                        @foreach ($allProducts as $productOption)
                                                            <option value="{{ $productOption->Id }}"
                                                                {{ old('products.' . $index . '.id', $product->product_id) == $productOption->Id ? 'selected' : '' }}>
                                                                {{ $productOption->Name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-lg-2 col-md-6">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="text" name="products[{{ $index }}][price]"
                                                        ...
                                                        value="{{ old('products.' . $index . '.price', $product->unit_price) }}"
                                                        readonly>
                                                    <!--end::Input-->
                                            ...
                                            <div class="col-lg-2 col-md-6">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="tel" name="products[{{ $index }}][amount]"
                                                        ...
                                                        value="{{ old('products.' . $index . '.amount', $product->unit_price * $product->quantity) }}"
                                                        readonly>
                                                    <!--end::Input-->
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="invoice_subtotal" id="invoice_subtotal"
                                                    ...
                                                    value="{{ old('invoice_subtotal', $invoice->sub_total) }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="invoice_tax" id="invoice_tax"
                                                    ...
                                                    value="{{ old('invoice_tax', $invoice->tax) }}">
                                            </div>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="invoice_grand_total" id="invoice_grand_total"
                                                    ...
                                                    value="{{ old('invoice_grand_total', $invoice->total) }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('drafts') }}" id="kt_ecommerce_add_product_cancel"
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button type="submit" id="kt_ecommerce_add_product_submit" class="btn btn-primary mx-2"  onclick="submitForm()">
...
@push('custom-scripts')
    <script>
        function submitForm() {
            document.getElementById('editDraftForm').action = "{{ route('store.invoice') }}";
        }

        function submitFormAsDraft() {
            document.getElementById('editDraftForm').action = "{{ route('store.draft.invoice') }}";
        }
