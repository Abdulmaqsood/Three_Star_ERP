                ...
                <form action="{{ route('update.subCategory', $subCategory->id) }}" method="POST"
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <style>
                                    .image-input-placeholder {
                                        background-image: url({{ asset('storage/subCategoryImages/' . $subCategory->icon) }});
                                    }
                                ...
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set the category image. Only *.png, *.jpg and *.jpeg
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">A subcategory name is required and recommended to be
                                        unique.
                                    </div>
                                    <!--end::Description-->
                                    @error('name')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="description" class="form-control mb-2"
                                        placeholder="Category description" value="{{ $subCategory->description }}">
                                    <!--end::Input-->
                                ...
                                {{-- <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container"
                                    ...
                                    <!--begin::Input-->
                                    <select name="category_id" data-placeholder="Select a Country..."
                                        ...
                                        @if ($categories)
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    @if ($subCategory->category->id == $category->id) selected @endif>{{ $category->name }}
                                                </option>
                                            @endforeach
                                        @else
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('subCategories')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">
                                Cancel
                            </a>
                            <!--end::Button-->
