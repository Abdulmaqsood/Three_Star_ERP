    ...
    <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class=" container-fluid ">
                ...
                <form action="{{ route('update.manufacturer', $user->id) }}" method="POST"
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <style>
                                    .image-input-placeholder {
                                        background-image: url({{ asset('storage/manufacturerImages/' . $user->image) }});
                                    }
                                ...
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set the Manufacturer image image. Only *.png, *.jpg and *.jpeg
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    <!--begin::Label-->
                                    <label class="required form-label">Manufacturer Name</label>
                                    <!--end::Label-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="email" name="email" class="form-control mb-2"
                                        placeholder="Manufacturer email" value="{{ $user->email }}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="address" class="form-control mb-2"
                                        placeholder="Manufacturer address" value="{{ $user->address }}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="city" class="form-control mb-2"
                                        placeholder="Manufacturer city" value="{{ $user->city }}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="state" class="form-control mb-2"
                                        placeholder="Manufacturer state" value="{{ $user->state }}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="country" class="form-control mb-2"
                                        placeholder="Manufacturer Country" value="{{ $user->country }}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="postal_code" class="form-control mb-2"
                                        placeholder=" Manufacturer Postal Code" value="{{ $user->postal_code }}">
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--begin::Input-->
                                    <input type="phone" name="contact_number" class="form-control mb-2"
                                ...
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="website" class="form-control mb-2"
                                        placeholder="Website url" value="{{ $user->website }}">
                                    <!--end::Input-->
