...
<div class=" container-fluid  d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
        ...
        <a href="{{route('dashboard')}}" class="d-lg-none">
            <img alt="Logo" src="{{asset('assets/media/logo.svg')}}" class="mh-40px" />
        </a>
        <!--end::Logo-->
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-6">
                            <a href="{{route('products')}}"
                                ...
                                <i class="bi bi-basket fs-3x text-primary mb-2"><span
                                        class="path1"></span><span class="path2"></span><span
                                        class="path3"></span></i> <span
                                    class="fs-5 fw-semibold text-gray-800 mb-0">Products</span>
                                <span class="fs-7 text-gray-400">All Products</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        ...
                        <div class="col-6">
                            <a href="{{route('invoices')}}"
                                ...
                                <i class="ki-duotone ki-abstract-41 fs-3x text-primary mb-2"><span
                                        class="path1"></span><span class="path2"></span></i> <span
                                    class="fs-5 fw-semibold text-gray-800 mb-0">Reports</span>
                                <span class="fs-7 text-gray-400">All Invoices </span>
                            </a>
                        </div>
                        <!--end:Item-->
                        ...
                        <div class="col-6">
                            <a href="{{route('customers')}}"
                                ...
                                <span class="fs-7 text-gray-400">All customers</span>
                            </a>
                        </div>
                        <!--end:Item-->
                    </div>
                ...
                @if (Auth::guard('web')->check())
                   ...
                   <form action="{{route('logout')}}" method="post">
                    @csrf
                     <!--begin::Menu item-->
                     <div class="menu-item px-5">
                        <button type="submit"  class="menu-link btn  px-5">
                            Sign Out 
                        </button>
                    </div>
                    <!--end::Menu item-->
